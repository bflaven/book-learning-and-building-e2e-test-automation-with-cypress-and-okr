...
003_wp_more_custom_commands_typescript.spec.ts
...
describe('002 :: E2E-WP :: Check local WP backend and show some custome command ', function () {
  
  it('002_1 :: Visit the WP', function () {
    cy.visit('/')
  })

  it('002_2 :: Some custom commands in TypeScript', function () {
