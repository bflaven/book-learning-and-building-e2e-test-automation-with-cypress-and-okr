...
012a_wp_admin_allvaluesvariables.cy.js
...
npx cypress run --config video=false,screenshotOnRunFailure=false --spec "cypress/integration/e2e-wp/012_wp_admin_allvaluesvariables.cy.js"
...
npx cypress run --env LANG="en_EN" --config-file "en_EN.conf.env.json" --config video=false,screenshotOnRunFailure=false

npx cypress run --env LANG="es_ES" --config-file "es_ES.conf.env.json" --config video=false,screenshotOnRunFailure=false


- launch the script only with no video and no screenshots

npx cypress run --env LANG="en_EN",port=4222,name="Bruno",project="MySuite_2e2"  --config-file "WP_EN.conf.env.json" --config video=false,screenshotOnRunFailure=false --spec "cypress/integration/e2e-wp/012_wp_admin_allvaluesvariables.cy.js"
...
describe('012_2 :: E2E-WP :: '+globalValues.lang+' :: Check local WP backend :: LOGIN ', function () {
...
describe('012_3 :: E2E-WP :: '+globalValues.lang+' :: Create a post in WP backend :: CREATE POST ', function () {

       it ('012_3_1 :: Create a post', () => {

            cy.log('coming soon create a post function') 
