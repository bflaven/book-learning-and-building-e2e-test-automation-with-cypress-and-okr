...
007_wp_admin_login_advanced.spec.js
...
describe('007_1 :: E2E-WP :: Check local WP backend :: VARIABLES ', function () {
...
describe('007_2 :: E2E-WP :: Check local WP backend :: LOGIN ', function () {

       it ('007_2_1 :: Login to WP with your Credentials', () => {
        cy.log('\n --- go the hp')
        cy.visit('/')
        cy.wait(timer)
        cy.log('\n --- go the backend')
