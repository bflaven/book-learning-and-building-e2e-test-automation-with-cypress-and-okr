...
Test the visibility if there is an overlay on the main form until that save action is done fo insstance.
```js
            // check visibility
...
Structure your test e.g 018_wp_make_screenshots.spec.js
```js
...
Few js notions
https://www.w3docs.com/snippets/javascript/how-to-convert-a-number-to-a-string-in-javascript.html
