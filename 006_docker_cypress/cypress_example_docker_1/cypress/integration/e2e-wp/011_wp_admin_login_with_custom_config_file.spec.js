...
011_wp_admin_login_with_custom_config_file.spec.js
...
npx cypress run --config video=false,screenshotOnRunFailure=false --spec "cypress/integration/e2e-wp/011_wp_admin_login_with_custom_config_file.spec.js"
...
npx cypress run --env LANG="en_EN",port=4222,name="Bruno",project="MySuite_2e2"  --config-file "en_EN.conf.env.json" --config video=false,screenshotOnRunFailure=false --spec "cypress/integration/e2e-wp/011_wp_admin_login_with_custom_config_file.spec.js"
