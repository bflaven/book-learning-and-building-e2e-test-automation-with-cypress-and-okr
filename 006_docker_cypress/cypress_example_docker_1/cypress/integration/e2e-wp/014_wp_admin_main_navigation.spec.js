...
014_wp_admin_create_content.spec.js
...
npx cypress run --env LANG="es_ES" --config video=false,screenshotOnRunFailure=false
...
npx cypress run --config video=false,screenshotOnRunFailure=false --spec "cypress/integration/e2e-wp/014_wp_admin_create_content.spec.js"
...
npx cypress run --env LANG="en_EN",port=4222,name="Bruno",project="MySuite_2e2"  --config-file "en_EN.conf.env.json" --config video=false,screenshotOnRunFailure=false --spec "cypress/integration/e2e-wp/014_wp_admin_create_content.spec.js"
...
npx cypress open --env LANG="fr_FR" --config-file "fr_FR.conf.env.json" --config video=false,screenshotOnRunFailure=false
...
describe('014a :: WP :: ensure the minimum WP backend functioning @content @creation @post @page @tag @user :: Testing ' + globalValues.LANGUAGE + ' (WpDebug) :: DEBUG @e2e @wp @required', function () {
    ...
    it('014a_1 :: WP :: ensure the minimum BACH functioning @ux @gui @main_navigation :: Testing ' + globalValues.LANGUAGE + ' :: MAIN NAV (WpFakeForLogic)', function () {
        // cy.WpFakeForLogic('main_navigation')
        cy.WpUxGuiTestingMainNavigation()
    })
    it.skip('014a_2 :: WP :: ensure the minimum BACH functioning @ux @gui @sub_navigation :: Testing ' + globalValues.LANGUAGE + ' :: MAIN NAV (WpFakeForLogic)', function () {
