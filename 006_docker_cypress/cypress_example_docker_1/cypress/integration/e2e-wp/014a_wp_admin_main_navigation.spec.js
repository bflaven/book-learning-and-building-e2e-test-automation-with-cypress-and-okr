...
014a_wp_admin_create_content.spec.js
...
npx cypress run --config video=false,screenshotOnRunFailure=false --spec "cypress/integration/e2e-wp/014a_wp_admin_create_content.spec.js"
...
npx cypress run --env LANG="en_EN",port=4222,name="Bruno",project="MySuite_2e2"  --config-file "en_EN.conf.env.json" --config video=false,screenshotOnRunFailure=false --spec "cypress/integration/e2e-wp/014a_wp_admin_create_content.spec.js"
...
describe('014a :: WP :: ensure the minimum WP backend functioning @content @creation @post @page @tag @user :: Testing ' + globalValues.LANGUAGE + ' (WpDebug) :: DEBUG @e2e @wp @required', function () {
    ...
    it('014a_2 :: WP :: ensure the minimum BACH functioning @ux @gui @sub_navigation :: Testing ' + globalValues.LANGUAGE + ' :: MAIN NAV (WpFakeForLogic)', function () {
