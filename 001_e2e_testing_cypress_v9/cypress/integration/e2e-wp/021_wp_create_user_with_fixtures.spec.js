...
021_wp_create_user_with_fixtures.spec.js
...
npx cypress run --config video=false,screenshotOnRunFailure=false --spec "cypress/integration/e2e-wp/021_wp_create_user_with_fixtures.spec.js"
...
npx cypress run --env LANG="en_EN",port=4222,name="Bruno",project="MySuite_2e2"  --config-file "WP_EN.conf.env.json" --config video=false,screenshotOnRunFailure=false --spec "cypress/integration/e2e-wp/021_wp_create_user_with_fixtures.spec.js"
...
describe('021 :: WP :: LOADING FIXTURES ::  ensure the minimum WP backend functioning @content @fixtures :: Testing ' + globalValues.lang + ' (WpDebug) :: DEBUG @fixtures @e2e @wp @required', function () {
    ...
    /* E2E SUITE */
    it('002_3 :: WP :: LOADING FIXTURES ', function () {
                // Load the data 
